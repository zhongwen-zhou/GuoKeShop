module Admin
	class ItemsController < BaseController
		...
		def create
			item = Item.new(params.require(:item).permit(:bar_code, :name, :brand, :units, :desc, :price, :repo_count, :on_way_count, :category_id, :on_sale, :hot, :new_arrivals, :on_shelf))
		...
		def update
			item = Item.find(params[:id])
			item.update_attributes!(params.require(:item).permit(:bar_code, :name, :brand, :units, :desc, :price, :repo_count, :on_way_count, :category_id, :in_price, :on_sale, :hot, :new_arrivals, :on_shelf))
			# item.save!
